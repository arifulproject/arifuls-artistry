...
CREATE POLICY "Admins can manage about" ON public.about_content FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can view about" ON public.about_content FOR SELECT TO public USING (true);
...
CREATE POLICY "Admins can manage posts" ON public.blog_posts FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can view active posts" ON public.blog_posts FOR SELECT TO public USING (is_active = true);
...
CREATE POLICY "Admins can manage messages" ON public.contact_messages FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can submit messages" ON public.contact_messages FOR INSERT TO public WITH CHECK (true);

-- faqs
DROP POLICY IF EXISTS "Admins can manage faqs" ON public.faqs;
DROP POLICY IF EXISTS "Anyone can view active faqs" ON public.faqs;
CREATE POLICY "Admins can manage faqs" ON public.faqs FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins can manage hero" ON public.hero_content FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can view hero" ON public.hero_content FOR SELECT TO public USING (true);
...
CREATE POLICY "Admins can manage projects" ON public.portfolio_projects FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can view active projects" ON public.portfolio_projects FOR SELECT TO public USING (is_active = true);
...
CREATE POLICY "Anyone can view approved reviews" ON public.reviews FOR SELECT TO public USING (status = 'approved'::text);
...
CREATE POLICY "Anyone can view active services" ON public.services FOR SELECT TO public USING (is_active = true);
...
CREATE POLICY "Admins can manage skills" ON public.skills FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can view active skills" ON public.skills FOR SELECT TO public USING (is_active = true);
